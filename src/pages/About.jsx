...
export default function About() {
  ...
  return (
    <div className=" bgCompany">
      ...
      <TitleHeader title={"درباره ما"} />
      <div className=" flex-col-center relative my-5 md:my-10">
        <h3 className="drop-shadow-xl text-black absolute text-4xl md:text-4xl vazir-bold">
          تاریخچه
        </h3>
        <div>
          <svg
            className="w-[280px] md:w-[220px] h-[80px] fill-orange-500"
      ...
      <div data-aos="zoom-in" className="text-white leading-[30px] md:leading-[40px] text-md md:text-2xl text-center px-4 md:px-10 vazir-bold mb-5  md:mb-10">
      ...
      <div className="w-full h-[300px] bg-[url(src/asset/images/info1.jpg)] bg-no-repeat bg-cover bg-fixed "></div>
