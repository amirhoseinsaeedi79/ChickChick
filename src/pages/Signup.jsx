        ...
        <div className=" bgCompany pt-36 pb-20 ">
          <div className=" w-full flex flex-col items-center  ">
            <form
              ...
              className="w-11/12  md:w-7/12 lg:w-5/12 flex-col-center border-2 bg2 border-orange-500 rounded-[40px] md:text-xl text-md"
            >
              <span className="text-orange-500 vazir-bold text-4xl mt-10">
                ثبت نام
              </span>
              <label
                className=" w-full text-right mr-14 md:mr-28 text-white text-xl vazir-bold mb-3 mt-5"
                htmlFor="#username"
              >
                :نام کاربری
              </label>
              ...
              <div className="w-full text-right py-5 text-white text-xl vazir-bold mb-3 ">
                <div className="flex-row-center text-[17px] md:text-xl text-center">
