  ...
  return (
    ...
    >
      <div className={`${status.status} relative my-5 md:my-10`}>
        ...
        <div>
          <svg
            className="w-[280px] md:w-[200px] h-[70px] fill-orange-500"
      ...
      >
        <SwiperSlide>
          <Link to="/pish">
            <div className="bg-pish h-[250px] rounded-2xl flex items-center justify-center  hover:opacity-80 ">
              <span className="text-white text-5xl vazir-bold text-shadow">
                پیش غذا
              </span>
            </div>
          </Link>
        ...
        <SwiperSlide>
          <Link to="/sokhari">
            <div className="bg-sokhari h-[250px] rounded-2xl flex items-center justify-center hover:opacity-80 ">
              <span className="text-white text-5xl vazir-bold text-shadow">
                سوخاری
              </span>
            </div>
        ...
        <SwiperSlide>
          <Link to="/mixbox">
            <div className="bg-mix h-[250px] rounded-2xl flex items-center justify-center hover:opacity-80 ">
              <span className="text-white text-5xl vazir-bold text-shadow">
                میکس باکس
              </span>
            </div>
        ...
        <SwiperSlide>
          <Link to="/sib">
            <div className="bg-sib h-[250px] rounded-2xl flex items-center justify-center hover:opacity-80 ">
              <span className="text-white text-5xl vazir-bold text-shadow">
                سیب زمینی
              </span>
            </div>
        ...
        <SwiperSlide>
          <Link to="/sandwich">
            <div className="bg-sandwich h-[250px] rounded-2xl flex items-center justify-center hover:opacity-80 ">
              <span className="text-white text-5xl vazir-bold text-shadow">
                ساندویچ
              </span>
            </div>
        ...
        <SwiperSlide>
          <Link to="/nosh">
            <div className="bg-nosh h-[250px] rounded-2xl flex items-center justify-center hover:opacity-80 ">
              <span className="text-white text-5xl vazir-bold text-shadow">
                نوشیدنی
              </span>
            </div>
