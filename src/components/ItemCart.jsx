...
export default function ItemCart(items) {
 ...
 async function numberremove(id) {
  ...
  return (
    <div className="h-[160px] md:h-[190px] xl:h-[220px] flex flex-row justify-between border-4 border-orange-500 rounded-2xl mx-2 md:mx-5  lg:mx-7 mb-5">
      ...
      <div className="w-6/12  flex-col-center  text-white">
        <div className="text-[19px] md:text-[27px] xl:text-[31px] vazir-bold  my-2 text-orange-500">
          <span>{items.name}</span>
        </div>
        <div className="vazir text-[15px] md:text-[18px] xl:text-[22px]">
          <span>تعداد :</span>
