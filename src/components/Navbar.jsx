...
export default function Navbar() {
  ...
  return (
    <>
      <nav className="w-full fixed top-0 z-50 bg-[url(./asset/images/body.jpg)] ">
        <div className=" lg:container  flex flex-row justify-between  ">
            ...
            <div className="flex flex-row justify-between lg:pt-2 relative">
              <Link onMouseOver={hoverUserIn} onMouseOut={hoverUserOut}>
                <svg
                  ...
                  strokeWidth={1.5}
                  stroke="currentColor"
                  className="cursor-pointer w-9 h-16 lg:w-9 h-19 ml-[15px] lg:ml-[30px] hover:!text-orange-500"
                >
                  <path
                    strokeLinecap="round"
          ...
          <div className=" hidden lg:flex-row-center relative ">
            <Link
              onClick={upHandler}
              to="/pish"
              className=" lg:text-[25px] text-black vazir-bold mx-7 my-5 hover:text-orange-300"
            >
              منو
            </Link>
            <Link
              onClick={upHandler}
              to="/gallery"
              className=" lg:text-[25px] vazir-bold mx-7 my-5 text-black hover:text-orange-500 "
            >
              گالری
            </Link>
            <Link
          ...
          <div className=" lg:hidden ">
            <img
              className=" cursor-pointer w-[60px] h-[60px] mr-8 rounded-full"
          ...
          >
            <svg
              ...
              strokeWidth={1.5}
              stroke="currentColor"
              className=" w-10 h-16 mr-4 cursor-pointer hover:!text-orange-500 "
            >
              <path
                strokeLinecap="round"
                strokeLinejoin="round"
          ...
          >
            ...
            <div className="w-full flex flex-col items-end  px-3 mx-auto mt-7">
              <div className="h-20 relative ">
                ...
                >
                  <div className=" text-[25px] font-vazir mr-5 mt-2">خانه</div>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
                ...
                <div className="z-[-2] ">
                  <svg
                    className="w-full h-14 fill-orange-400 "
                    xmlns="http://www.w3.org/2000/svg"
                    x="0px"
                    y="0px"
              ...
              <div className="h-20 relative ">
                <Link
                  ...
                  className="w-full flex flex-row items-center justify-end pr-9 absolute text-black hover:text-white"
                >
                  <div className=" text-[22px] font-vazir mr-5 my-3">منو</div>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
                    fill="currentColor"
              ...
              <div className="h-20 relative  ">
                <Link
                  ...
                  className="w-full flex flex-row items-center justify-end pr-9 absolute text-black hover:text-white "
                >
                  <div className=" text-[25px] font-vazir mr-5 my-3">گالری</div>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
              ...
              <div className="h-20 relative ">
                <Link
                  ...
                  className="w-full flex flex-row items-center justify-end pr-9 absolute text-black hover:text-white"
                >
                  <div className=" text-[25px] font-vazir mr-5 my-3">
                    شعبه ها
                  </div>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
