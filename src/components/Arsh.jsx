...
export default function Arsh() {
  ...
  return (
    <div className="w-full bgcall  mt-20 ">
      <div className="w-full flex-col-center vazir-bold">
        <h2 className="w-full text-center border-b-2 border-orange-500 text-3xl md:text-5xl py-10 bg2 text-white">
          شعبه آجودانیه
        </h2>
        <div className=" flex-col-center relative my-5 md:my-10">
          <h3 className="drop-shadow-xl text-black absolute text-3xl md:text-4xl vazir-bold">
            اطلاعات این شعبه
          </h3>
          <div>
            <svg
              className="w-[280px] md:w-[320px] h-[80px] fill-orange-500"
        ...
        <div className="flex flex-col items-end ">
          ...
          >
            <span className="pr-3  text-[11px] md:text-2xl">
              آدرس : آجودانیه مجتمع تجاری عرش آجودانیه طبقه اول
            </span>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              ...
              strokeWidth={1.5}
              stroke="currentColor"
              className="w-10 h-10 text-white rounded-full border-2 border-white p-1"
            >
              <path
                strokeLinecap="round"
          ...
          <div
            ...
            className="flex-row-center mt-5 text-white "
          >
            <span className="pr-3 text-[13px] md:text-2xl">
              021-45268452 : شماره تماس{" "}
            </span>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
          ...
          >
            <span className="flex-row-center text-[13px] md:text-2xl pr-3 text-white">
        ...
        <span data-aos="zoom-in" className="text-orange-500 text-3xl pb-5 ">
          منوی غذایی متنوع
        </span>
        <p
          data-aos="zoom-in"
          className="text-white pb-6 px-2 text-center text-xl "
        >
        ...
        <span data-aos="zoom-in" className="text-orange-500 text-3xl py-5 ">
          پارکینک اختصاصی
        </span>
        <p
          data-aos="zoom-in"
      ...
      <div className=" flex-col-center relative my-5 md:my-10">
        <h3 className="drop-shadow-xl text-black absolute text-2xl md:text-3xl vazir-bold">
          محصولات این شعبه
        </h3>
        <div>
          <svg
      ...
      <div className=" flex-col-center relative py-5 md:py-8">
        <h3 className="drop-shadow-xl text-black absolute text-2xl md:text-3xl vazir-bold">
          نظر مشتریان
        </h3>
        <div>
          <svg
            className="w-[200px] md:w-[250px] h-[80px] fill-orange-500"
            xmlns="http://www.w3.org/2000/svg"
            x="0px"
            y="0px"
            viewBox="0 0 229.1 42.6"
      ...
      <div className="allcoment">
        <div className="container flex-col-center ">
          <div
            className={`container w-10/12 md:w-1/2 border-4 border-orange-500 text-white rounded-[40px] md:rounded-[50px] bg2 my-10`}
          >
            <form
              onSubmit={handleSubmit(registerHandler)}
              className=" flex-col-center  px-2"
            >
              <h5 className="text-3xl vazir-bold py-5">ثبت نظر جدید</h5>

              <label className="text-lg  vazir my-2" htmlFor="#text">
                : نظر خودرا وارد کنید
              </label>
              <textarea
                {...register("text", {
                ...
                id="text"
                className="rounded-3xl text-black w-[95%] h-[120px]  md:h-[150px]  border-4 border-orange-500 focus:outline-none text-xl vazir py-3 px-5"
                cols="46"
                rows="5"
              ></textarea>
              ...
              <button
                className="text-xl py-2 hover:bg-white hover:text-black  border-4 border-orange-500 cursor-pointer vazir-bold rounded-full p-5 sm:px-10 mx-2 my-5"
                type="submit"
              >
                ارسال
              </button>
          ...
          <div className="  w-4/6 p-5 flex flex-col items-end justify-center my-5 md:my-5  border-2 border-orange-500 bg2 rounded-[40px]">
            <div className="flex-row-center mb-5 ">
              <div className=" flex flex-col items-end mr-2 ">
                <span className="text-white text-[13px] md:text-xl vazir-bold">
                  امیرحسین سعیدی
                </span>
                <span className="text-gray-300 text-md vazir">مشتری</span>
              </div>
              <div>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  ...
                  strokeWidth={1.5}
                  stroke="currentColor"
                  className="w-12 h-12 md:w-16 md:h-w-16 text-white "
                >
                  <path
                    strokeLinecap="round"
                    strokeLinejoin="round"
            ...
            <div className="w-full text-center vazir-bold py-5 text-black bg-white text-lg mb-3 rounded-[20px] border-2 border-orange-500">
