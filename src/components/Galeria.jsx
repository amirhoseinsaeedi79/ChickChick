...
if (login) {
 ...
 toast.error('برای ثبت نظر لطفا ابتدا ثبت نام کنید', {
  ...
  return (
    <div className="w-full bgcall bg-no-repeat mt-20 ">
      <div className="w-full flex-col-center vazir-bold">
        ...
        <div className="flex flex-col items-end ">
          ...
          >
            <span className="pr-3  text-[12px] md:text-2xl">
              آدرس : ولنجک مجتمع تجاری گالریا طبقه سوم
            </span>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
          ...
          >
            <form onSubmit={handleSubmit(registerHandler)} className=" flex-col-center  px-2">
             ...
             {...register('text',{
              ...
              <button  className="text-xl py-2 hover:bg-white hover:text-black  border-4 border-orange-500 cursor-pointer vazir-bold rounded-full p-5 sm:px-10 mx-2 my-5"
