        ...
        <div className="container flex-row-center  flex-wrap lg:flex-nowrap">
          <div className="w-[500px] flex-col-center lg:relative lg:right-14 xl:relative xl:right-36">
            <div className="flex-row-center">
              <h4 className="lg:text-4xl md:text-5xl text-2xl vazir-bold m-3 text-white">
                سوخاری چیک چیک
              </h4>
              <img
            ...
            <div className=" mt-2 md:my-6 flex-row-center">
              <img
                className="w-20 h-16 cursor-pointer mx-3"
                src="/src/asset/images/Telegram.svg"
                alt=""
              />

              <img
                className="w-20 h-14 cursor-pointer mx-3"
          ...
          <div className="flex flex-col items-end xl:relative xl:left-20">
            <div className="flex-row-center mb-3">
              <p className="text-white text-[13px] md:text-xl lg:text-[18px]">
            ...
            <div className="flex-row-center mb-3">
              <p className="text-white text-[13px] md:text-xl lg:text-[19px]">
            ...
            <div className="flex-row-center mb-3">
              <p className="text-white text-[12px] md:text-xl lg:text-[20px]">
